...
print(my_bucket_voltaje, my_bucket_corriente, my_bucket_potencia, my_bucket_water)
...
def proccess_function(mesage, bucket):
    print(mesage)
    ...
    try:
        ...
        point = Point(bucket+'_target').field(bucket, mesage).time(datetime.utcnow(), WritePrecision.NS)
